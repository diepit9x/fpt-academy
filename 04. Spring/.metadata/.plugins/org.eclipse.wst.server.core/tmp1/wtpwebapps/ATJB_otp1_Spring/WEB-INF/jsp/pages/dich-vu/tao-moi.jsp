...
<form:form action="${pageContext.request.contextPath}/dich-vu/tao-moi"
	...
	<c:if test="${success}">
		<div class="alert alert-success">Tạo mới dịch vụ thành công!</div>
	</c:if>
	...
	<div class="form-group row pt-md-3">
		...
		<div class="col-md-10">
			<form:select class="form-control" path="donViTinh" name="donViTinh"
				id="donViTinh">
	...
	<div class="form-group row pt-md-3">
		...
		<div class="col-md-10">
			<form:input type="number" class="form-control" path="donGia"
				id="donGia" name="donGia" placeholder="Đơn giá" />
		</div>
	</div>
